...
## Histogram
There are functions that can generate a histogram and provide all the information about it. However, a histogram can also be obtained using the `getCell()` and `getCount()` function of `rgrids`.
